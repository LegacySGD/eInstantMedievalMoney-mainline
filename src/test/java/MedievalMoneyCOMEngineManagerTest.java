...
public class MedievalMoneyCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MedievalMoneyCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MedievalMoneyIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MedievalMoneyIW/InitOutcome.xml").getDocumentElement();
